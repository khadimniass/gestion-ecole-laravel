...
@section('title', 'Proposer un Sujet PFE')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-plus"></i> Proposer un Sujet PFE</h1>
            ...
            <form action="{{ route('sujets.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('niveau_requis') is-invalid @enderror"
                            ...
                            <option value="tous" {{ old('niveau_requis') == 'tous' ? 'selected' : '' }}>Tous</option>
                        </select>
                        @error('niveau_requis')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('nombre_etudiants_max') is-invalid @enderror"
                               ...
                               value="{{ old('nombre_etudiants_max', 2) }}" min="1" max="3" required>
                        ...
                        <div id="mots-cles-container">
                            @for($i = 0; $i < 4; $i++)
                                <input type="text" class="form-control mb-2 @error('mots_cles.'.$i) is-invalid @enderror"
                                       name="mots_cles[]" value="{{ old('mots_cles.'.$i) }}"
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-save"></i> Proposer le sujet
                    </button>
                </div>
            </form>
        </div>
